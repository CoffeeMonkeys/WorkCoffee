		...
		<div class="navbar">
			...
			<div class="contents">
				...
				<div class="searchBar">
					...
					<button on:click={fetchCoffeeStores} type="button" id="SearchButton"
						>Enter Your City</button
					>
				</div>
				<div class="user">
...
<style>
	...
	.Middle {
		...
		border-image: url('https://img.freepik.com/free-photo/wooden-textured-background_53876-14865.jpg?size=626&ext=jpg&ga=GA1.1.735520172.1710979200&semt=ais')
			30 repeat;
		border-radius: 5px;
		margin-left: -10px;
	}
	...
	.Middle .tRcontainer .coffeeShop h1,
	h3 {
		margin-left: 5px;
	}
